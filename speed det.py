...
# email_user = 'yourownemail@gmail.com'
# email_password = 'youremialpassword'
# email_send = 'receiveremail@gmail.com'
        ...
        for carID in carTracker.keys():
            ...
            if carID not in startTracker and mark2 > ty+th > mark1 and ty < mark1:
                ...
                if speed > speedLimit:
                    ...
                    list_of_files = glob.glob(r'\overspeeding\cars/*') # * means all if need specific format 
